...
void ShowScrollableMultichoice(void)
{
    ...
    case SCROLL_MULTI_BF_RECEPTIONIST:
        ...
        task->tTaskId = taskId;
        break;
    case SCROLL_MULTI_SLATEPORT_MOVE_TUTOR:
    case SCROLL_MULTI_MAUVILLE_MOVE_TUTOR:
    case SCROLL_MULTI_FALLARBOR_MOVE_TUTOR:
...
static const u8 *const sScrollableMultichoiceOptions[][MAX_SCROLL_MULTI_LENGTH] =
{
    ...
    [SCROLL_MULTI_SLATEPORT_MOVE_TUTOR] =
    {
        COMPOUND_STRING("FURY CUTTER"),
        COMPOUND_STRING("ROLLOUT"),
        COMPOUND_STRING("MUD-SLAP"),
        COMPOUND_STRING("MIMIC"),
        COMPOUND_STRING("METRONOME"),
        COMPOUND_STRING("SEISMIC TOSS"),
        COMPOUND_STRING("SWIFT"),
        COMPOUND_STRING("AIR CUTTER"),
        COMPOUND_STRING("ANCIENTPOWER"),
        COMPOUND_STRING("ICY WIND"),
        COMPOUND_STRING("IRON DEFENSE"),
        COMPOUND_STRING("TWISTER"),
        COMPOUND_STRING("BUG BITE"),
        COMPOUND_STRING("VACUUM WAVE"),
        COMPOUND_STRING("CORROSIVE GAS"),
        COMPOUND_STRING("SILK SHOT"),
        gText_Exit
    },
    [SCROLL_MULTI_MAUVILLE_MOVE_TUTOR] =
    {
        COMPOUND_STRING("HELPING HAND"),
        COMPOUND_STRING("MAGNET RISE"),
        COMPOUND_STRING("OMINOUS WIND"),
        COMPOUND_STRING("SIGNAL BEAM"),
        COMPOUND_STRING("ZEN HEADBUTT"),
        COMPOUND_STRING("LOW KICK"),
        COMPOUND_STRING("TAILWIND"),
        COMPOUND_STRING("WORRY SEED"),
        COMPOUND_STRING("SUPER FANG"),
        COMPOUND_STRING("GRASSY GLIDE"),
        COMPOUND_STRING("DUAL WINGBEAT"),
        COMPOUND_STRING("COACHING"),
        COMPOUND_STRING("TERRAIN PULSE"),
        COMPOUND_STRING("SKITTER SMACK"),
        COMPOUND_STRING("FLIP TURN"),
        COMPOUND_STRING("TRIPLE AXEL"),
        COMPOUND_STRING("DRACO MAW"),
        gText_Exit
    },
    [SCROLL_MULTI_VERDANTURF_MOVE_TUTOR] =
    {
        ...
        COMPOUND_STRING("RISING VOLTAGE"),
        COMPOUND_STRING("SCORCHING SANDS"),
        COMPOUND_STRING("DUAL WINGBEAT"),
    ...
    {
        COMPOUND_STRING("JAW LOCK"),
        COMPOUND_STRING("BODY SLAM"),
        COMPOUND_STRING("ROCK SLIDE"),
        COMPOUND_STRING("DYNAMIC PUNCH"),
        COMPOUND_STRING("AQUA TAIL"),
        COMPOUND_STRING("BOUNCE"),
        COMPOUND_STRING("IRON HEAD"),
        COMPOUND_STRING("DRILL RUN"),
        COMPOUND_STRING("HYPER VOICE"),
        COMPOUND_STRING("OUTRAGE"),
        COMPOUND_STRING("SUPERPOWER"),
        COMPOUND_STRING("MISTY EXPLOSION"),
        COMPOUND_STRING("STEEL ROLLER"),
        COMPOUND_STRING("METEOR BEAM"),
        COMPOUND_STRING("POLTERGEIST"),
