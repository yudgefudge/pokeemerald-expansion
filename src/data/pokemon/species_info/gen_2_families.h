...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_CHIKORITA] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_GRASS_PELT, ABILITY_LEAF_GUARD },
    ...
    [SPECIES_MEGANIUM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_OVERGROW, ABILITY_GRASSY_SURGE, ABILITY_TRIAGE },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_CYNDAQUIL] =
    {
        ...
        .abilities = { ABILITY_BLAZE, ABILITY_WHITE_SMOKE, ABILITY_FLASH_FIRE },
    ...
    [SPECIES_TYPHLOSION] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BLAZE, ABILITY_TRANSISTOR, ABILITY_FLASH_FIRE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_SENTRET] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FRISK, ABILITY_KEEN_EYE, ABILITY_FRISK },
    ...
    [SPECIES_FURRET] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FRISK, ABILITY_ADAPTABILITY, ABILITY_FUR_COAT },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_NOCTOWL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_MAGIC_GUARD, ABILITY_KEEN_EYE, ABILITY_TINTED_LENS },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_LEDIAN] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_MOXIE, ABILITY_IRON_FIST },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_SPINARAK] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_REGENERATOR, ABILITY_SNIPER },
        .bodyColor = BODY_COLOR_GREEN,
...
#define TOGEPI_FAMILY_TYPE1 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_TOGEPI] =
    {
        ...
        .abilities = { ABILITY_HUSTLE, ABILITY_SERENE_GRACE, ABILITY_FAIRY_AURA },
    ...
    [SPECIES_AMPHAROS] =
    {
        .baseHP        = 90,
        .baseAttack    = 55,
        .baseDefense   = P_UPDATED_STATS >= GEN_6 ? 95 : 75,
        .baseSpeed     = 55,
        .baseSpAttack  = 115,
        .baseSpDefense = 100,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_STATIC, ABILITY_MOLD_BREAKER, ABILITY_DRIZZLE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_HOPPIP] =
    {
        ...
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_AERILATE, ABILITY_WIND_RIDER },
    #else
    ...
    [SPECIES_MISDREAVUS] =
    {
        ...
        .abilities = { ABILITY_LEVITATE, ABILITY_SOUL_HEART, ABILITY_NONE },
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_QWILFISH] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 40, SPECIES_OVERQWIL}),
    },
    ...
    [SPECIES_HERACROSS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_GUTS, ABILITY_SKILL_LINK },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SNEASEL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SNOW_CLOAK, ABILITY_TECHNICIAN, ABILITY_PICKPOCKET },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
    ...
    [SPECIES_SLUGMA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_MAGMA_ARMOR, ABILITY_FLAME_BODY, ABILITY_DRY_SKIN },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_MAGCARGO] =
    {
        .baseHP        = P_UPDATED_STATS >= GEN_7 ? 65 : 50,
        .baseAttack    = 50,
        .baseDefense   = 130,
        .baseSpeed     = 30,
    ...
    [SPECIES_MAMOSWINE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SLUSH_RUSH, ABILITY_SNOW_CLOAK, ABILITY_THICK_FAT },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_CORSOLA] =
    {
        ...
        .abilities = { ABILITY_WATER_BUBBLE, ABILITY_NATURAL_CURE, ABILITY_REGENERATOR },
        .bodyColor = BODY_COLOR_PINK,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_HUSTLE, ABILITY_MEGA_LAUNCHER, ABILITY_MOODY },
    #else
    ...
    [SPECIES_OCTILLERY] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_WATER_2),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SUCTION_CUPS, ABILITY_MEGA_LAUNCHER, ABILITY_MOODY },
    #else
    ...
    [SPECIES_MANTYKE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_HOSPITALITY, ABILITY_WATER_ABSORB, ABILITY_WATER_VEIL },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_MANTINE] =
    {
        ...
        .abilities = { ABILITY_HOSPITALITY, ABILITY_LIGHTNING_ROD, ABILITY_WATER_VEIL },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SKARMORY] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_IRON_BARBS, ABILITY_STURDY, ABILITY_WEAK_ARMOR },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_PHANPY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PICKUP, ABILITY_WATER_COMPACTION, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_DONPHAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STURDY, ABILITY_WATER_COMPACTION, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_STANTLER] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_TERRIFY, ABILITY_POWER_SPOT, ABILITY_SAP_SIPPER },
    #else
    ...
    #if P_GEN_8_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 40, SPECIES_WYRDEER, }),
    #endif
    },
