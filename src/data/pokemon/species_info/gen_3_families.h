...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_SCEPTILE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "This Pokémon hides in the trees, ambushing\n"
            "Pokémon. It uses the balls of gas along its\n"
            "back as smoke bombs."),
        .pokemonScale = 256,
        .pokemonOffset = -1,
        .trainerScale = 275,
    ...
    [SPECIES_TORCHIC] =
    {
        ...
        .abilities = { ABILITY_BLAZE, ABILITY_KICKSTART, ABILITY_SPEED_BOOST },
    ...
    [SPECIES_SWAMPERT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_TORRENT, ABILITY_PRISM_ARMOR, ABILITY_SWIFT_SWIM },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_WURMPLE] =
    {
        ...
        .abilities = { ABILITY_SHIELD_DUST, ABILITY_RIVALRY, ABILITY_RUN_AWAY },
        .bodyColor = BODY_COLOR_RED,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 10, SPECIES_SILCOON, CONDITIONS({IF_NOT_TIME, TIME_NIGHT})},
                                {EVO_LEVEL, 10, SPECIES_CASCOON, CONDITIONS({IF_TIME, TIME_NIGHT})}),
    },
    ...
    [SPECIES_SILCOON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SHED_SKIN, ABILITY_RIVALRY, ABILITY_RUN_AWAY },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
    ...
    [SPECIES_BEAUTIFLY] =
    {
        ...
        .baseDefense   = 80,
        .baseSpeed     = 85,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_6 ? 70 : 90,
        .baseSpDefense = 80,
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_DAZZLING, ABILITY_RIVALRY, ABILITY_TRIAGE },
    ...
    [SPECIES_DUSTOX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_REGENERATOR, ABILITY_RIVALRY, ABILITY_POISON_PUPPETEER },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_SHIFTRY] =
    {
        ...
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_WIND_RIDER, ABILITY_CONTRARY },
    #else
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_EARLY_BIRD, ABILITY_PICKPOCKET },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_GARDEVOIR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = RALTS_FAMILY_EGG_GROUPS,
        .abilities = { ABILITY_SYNCHRONIZE, ABILITY_TRACE, ABILITY_MISTY_SURGE },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_MASQUERAIN] =
    {
        ...
        .baseAttack    = 60,
        .baseDefense   = 62,
        .baseSpeed     = P_UPDATED_STATS >= GEN_7 ? 106 : 60,
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_BUG),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_TERRIFY, ABILITY_UNNERVE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_MEDITITE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_PURE_POWER, ABILITY_FINESSE, ABILITY_TELEPATHY },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_MANECTRIC] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STATIC, ABILITY_LIGHTNING_ROD, ABILITY_HADRON_ENGINE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_PLUSLE] =
    {
        ...
        .abilities = { ABILITY_PLUS, ABILITY_TRANSISTOR, ABILITY_LIGHTNING_ROD },
    #else
    ...
    [SPECIES_VOLBEAT] =
    {
        ...
        .abilities = { ABILITY_ILLUMINATE, ABILITY_SWARM, ABILITY_COSTAR },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_ILLUMISE] =
    {
        ...
        .baseSpeed     = 75,
        .baseSpAttack  = 73,
        .baseSpDefense = P_UPDATED_STATS >= GEN_7 ? 95 : 75,
        .types = MON_TYPES(TYPE_BUG, TYPE_FAIRY),
        .catchRate = 150,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 151,
    ...
    [SPECIES_GULPIN] =
    {
        ...
        .abilities = { ABILITY_LIQUID_OOZE, ABILITY_SIMPLE, ABILITY_GLUTTONY },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_WAILORD] =
    {
        ...
        .growthRate = GROWTH_FLUCTUATING,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_WATER_2),
        .abilities = { ABILITY_DRIZZLE, ABILITY_OBLIVIOUS, ABILITY_PRESSURE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_NUMEL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_PYROCLASTIC, ABILITY_SOLID_ROCK, ABILITY_OWN_TEMPO },
    #else
    ...
    [SPECIES_CAMERUPT] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_PYROCLASTIC, ABILITY_SOLID_ROCK, ABILITY_ANGER_POINT },
    #else
    ...
    [SPECIES_GRUMPIG] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_THICK_FAT, ABILITY_MAGIC_BOUNCE, ABILITY_GLUTTONY },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SWABLU] =
    {
        ...
        .abilities = { ABILITY_PIXILATE, ABILITY_FILTER, ABILITY_CLOUD_NINE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SEVIPER] =
    {
        ...
        .abilities = { ABILITY_SHED_SKIN, ABILITY_NONE, ABILITY_CORROSION },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
    ...
    [SPECIES_BALTOY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_MUMMY },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_SHUPPET] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_INSOMNIA, ABILITY_SCRAPPY, ABILITY_CURSED_BODY },
    #else
    ...
    [SPECIES_BANETTE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_SCRAPPY, ABILITY_CURSED_BODY },
    #else
        .abilities = { ABILITY_INSOMNIA, ABILITY_NONE, ABILITY_CURSED_BODY },
    #endif
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_DUSKULL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_LEVITATE, ABILITY_FRISK, ABILITY_HUSTLE },
    #else
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE },
    #endif
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_DUSKNOIR] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_REAPER, ABILITY_IRON_FIST, ABILITY_HUSTLE },
    #else
        .abilities = { ABILITY_PRESSURE, ABILITY_NONE, ABILITY_NONE },
    #endif
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_CHINGLING] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_LEVITATE, ABILITY_SOUNDPROOF, ABILITY_NEUROFORCE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_CHIMECHO] =
    {
        .baseHP        = P_UPDATED_STATS >= GEN_7 ? 105 : 65,
        .baseAttack    = 30,
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_LEVITATE, ABILITY_PUNK_ROCK, ABILITY_NEUROFORCE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_ABSOL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_CONTRARY, ABILITY_SUPER_LUCK, ABILITY_JUSTIFIED },
    #else
    ...
    [SPECIES_GLALIE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_MINERAL),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_INTIMIDATE, ABILITY_ICE_BODY, ABILITY_MOODY },
    #else
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_NONE, ABILITY_MOODY },
    #endif
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_FROSLASS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_MINERAL),
        .abilities = { ABILITY_TERRIFY, ABILITY_ICE_BODY, ABILITY_CURSED_BODY },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_HUNTAIL] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_OPPORTUNIST, ABILITY_WATER_VEIL },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_RELICANTH] =
    {
        ...
        .abilities = { ABILITY_UNAWARE, ABILITY_ROCK_HEAD, ABILITY_STURDY },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_LUVDISC] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_HEALER, ABILITY_SOUL_HEART, ABILITY_HYDRATION },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_BAGON] =
    {
        ...
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_SHELL_ARMOR, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Bagon"),
        .cryId = CRY_BAGON,
