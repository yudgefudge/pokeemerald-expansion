...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_BULBASAUR] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_NATURAL_CURE, ABILITY_CHLOROPHYLL },
...
#define BLASTOISE_SP_DEF (P_UPDATED_STATS >= GEN_2 ? 105 : 85)
    ...
    [SPECIES_CATERPIE] =
    {
        ...
        .abilities = { ABILITY_SHIELD_DUST, ABILITY_CUTE_CHARM, ABILITY_RUN_AWAY },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_METAPOD] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SHED_SKIN, ABILITY_CUTE_CHARM, ABILITY_NONE },
        .bodyColor = BODY_COLOR_GREEN,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 20, SPECIES_BUTTERFREE}),
    },
    ...
    [SPECIES_KAKUNA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SHED_SKIN, ABILITY_SNIPER, ABILITY_NONE },
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 20, SPECIES_BEEDRILL}),
    },

    [SPECIES_BEEDRILL] =
    {
        .baseHP        = 65,
        .baseAttack    = P_UPDATED_STATS >= GEN_6 ? 125 : 80,
        .baseDefense   = 40,
        .baseSpeed     = 100,
        .baseSpAttack  = 55,
        .baseSpDefense = P_UPDATED_STATS >= GEN_2 ? 75 : 45,
        .types = MON_TYPES(TYPE_BUG, TYPE_POISON),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 198,
    ...
    [SPECIES_RATICATE] =
    {
        ...
        .baseSpeed     = 108,
        .baseSpAttack  = 50,
        .baseSpDefense = P_UPDATED_STATS >= GEN_2 ? 75 : 50,
        .types = MON_TYPES(TYPE_NORMAL),
        .catchRate = 127,
    ...
    [SPECIES_FEAROW] =
    {
        ...
        .weight = 380,
        .description = COMPOUND_STRING(
            "Its dark plumage and blood red\n"
            "appendages and wing tips strike\n"
    ...
    {
        .baseHP        = 75,
        .baseAttack    = P_UPDATED_STATS >= GEN_7 ? 115 : 85,
        .baseDefense   = 69,
        .baseSpeed     = 95,
        .baseSpAttack  = 65,
...
#define PIKACHU_SP_DEF (P_UPDATED_STATS >= GEN_6 || P_UPDATED_STATS == GEN_1 ? 50 : 40)
    ...
    [SPECIES_RAICHU] =
    {
        ...
        .baseAttack    = 80,
        .baseDefense   = 55,
        .baseSpeed     = P_UPDATED_STATS >= GEN_6 ? 120 : 100,
        .baseSpAttack  = 110,
    ...
    [SPECIES_NIDOQUEEN] =
    {
        ...
        .baseSpeed     = 66,
        .baseSpAttack  = 75,
        .baseSpDefense = P_UPDATED_STATS >= GEN_2 ? 105 : 75,
    ...
    {
        .baseHP        = 81,
        .baseAttack    = P_UPDATED_STATS >= GEN_6 ? 82 : 92,
        .baseDefense   = 77,
        .baseSpeed     = 95,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 95 : 75,
        .baseSpDefense = 75,
        .types = MON_TYPES(TYPE_POISON, TYPE_GROUND),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
    ...
    [SPECIES_WIGGLYTUFF] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_COMPETITIVE, ABILITY_SIMPLE },
    #else
    ...
    [SPECIES_CROBAT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_UNSEEN_FIST, ABILITY_SNIPER, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_VILEPLUME] =
    {
        ...
        .baseDefense   = 95,
        .baseSpeed     = 50,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_6 ? 120 : 100,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_MERCILESS, ABILITY_EFFECT_SPORE },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_BELLOSSOM] =
    {
        .baseHP        = 75,
        .baseAttack    = 80,
        .baseDefense   = P_UPDATED_STATS >= GEN_6 ? 60 : 85,
        .baseSpeed     = 110,
        .baseSpAttack  = 110,
        .baseSpDefense = 65,
    ...
    [SPECIES_PARASECT] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG, EGG_GROUP_GRASS),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_COMATOSE, ABILITY_DRY_SKIN, ABILITY_DAMP },
    #else
        .abilities = { ABILITY_EFFECT_SPORE, ABILITY_NONE, ABILITY_DAMP },
    #endif
        .bodyColor = BODY_COLOR_RED,
        ...
        .weight = 295,
        .description = COMPOUND_STRING(
            "Parasect's body has passed on, and it\n"
            "is puppeted by the mushroom on its back.\n"
            "This has led to scientists reclassifying\n"
            "it as a GHOST type."),
        .pokemonScale = 307,
        .pokemonOffset = 8,
        .trainerScale = 256,
    ...
    [SPECIES_VENOMOTH] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SHIELD_DUST, ABILITY_TINTED_LENS, ABILITY_BERSERK },
    #else
    ...
    [SPECIES_MANKEY] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_ANGER_POINT, ABILITY_DEFIANT },
    #else
    ...
    [SPECIES_ANNIHILAPE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_CLOUD_NINE, ABILITY_DEFIANT },
        .bodyColor = BODY_COLOR_GRAY,
        .noFlip = TRUE,
    ...
    [SPECIES_ARCANINE] =
    {
        ...
        .baseDefense   = 80,
        .baseSpeed     = 95,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 90 : 80,
        .baseSpDefense = 80,
        .types = MON_TYPES(TYPE_FIRE),
        .catchRate = 75,
    ...
    [SPECIES_ABRA] =
    {
        ...
        .abilities = { ABILITY_SYNCHRONIZE, ABILITY_ADAPTABILITY, ABILITY_MAGIC_GUARD },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Abra"),
        .cryId = CRY_ABRA,
    ...
    [SPECIES_BELLSPROUT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_STENCH, ABILITY_SHARPNESS, ABILITY_GLUTTONY },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_TENTACRUEL] =
    {
        ...
        .baseDefense   = 65,
        .baseSpeed     = 100,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 90 : 120,
        .baseSpDefense = 120,
        .types = MON_TYPES(TYPE_WATER, TYPE_POISON),
        .catchRate = 60,
    ...
    [SPECIES_GOLEM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_STURDY, ABILITY_TOUGH_CLAWS },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Golem"),
        .cryId = CRY_GOLEM,
    ...
    [SPECIES_RAPIDASH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_CHILLING_NEIGH, ABILITY_FLASH_FIRE, ABILITY_FLAME_BODY },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_SLOWBRO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_ICE_SCALES, ABILITY_REGENERATOR },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_SLOWKING] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_FUR_COAT, ABILITY_REGENERATOR },
        .bodyColor = BODY_COLOR_PINK,
...
#define MAGNEMITE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_2 ? TYPE_STEEL : TYPE_ELECTRIC)
    ...
    [SPECIES_FARFETCHD] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 31, SPECIES_SIRFETCHD}),
    },
    ...
    [SPECIES_DODUO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_PARENTAL_BOND, ABILITY_EARLY_BIRD, ABILITY_TANGLED_FEET },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Doduo"),
        .cryId = CRY_DODUO,
    ...
    [SPECIES_SEEL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_SLUSH_RUSH, ABILITY_ICE_BODY },
    #else
    ...
    [SPECIES_DEWGONG] =
    {
        ...
        .baseDefense   = 60,
        .baseSpeed     = 70,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 90 : 95,
        .baseSpDefense = 65,
    ...
    [SPECIES_GRIMER] =
    {
        ...
        .abilities = { ABILITY_STENCH, ABILITY_GOOEY, ABILITY_POISON_TOUCH },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_MUK] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_BAD_TACTICS, ABILITY_GOOEY, ABILITY_POISON_TOUCH },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Muk"),
        .cryId = CRY_MUK,
...
#define GENGAR_SP_DEF (P_UPDATED_STATS >= GEN_2 ? 75 : 130)
    ...
    [SPECIES_DROWZEE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 31, SPECIES_HYPNO}),
    },
    ...
    [SPECIES_KRABBY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_HAMMER_TIME, ABILITY_SHELL_ARMOR, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_VOLTORB] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_ELECTRIC_SURGE, ABILITY_STATIC, ABILITY_AFTERMATH },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_MAROWAK] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_SKILL_LINK, ABILITY_BATTLE_ARMOR },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
    ...
    [SPECIES_HITMONLEE] =
    {
        ...
        .baseSpeed     = 107,
        .baseSpAttack  = 35,
        .baseSpDefense = P_UPDATED_STATS >= GEN_2 ? 70 : 35,
        .types = MON_TYPES(TYPE_FIGHTING),
        .catchRate = 45,
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_LIMBER, ABILITY_KICKSTART, ABILITY_UNBURDEN },
    #else
    ...
    [SPECIES_HITMONCHAN] =
    {
        ...
        .baseSpeed     = 76,
        .baseSpAttack  = 35,
        .baseSpDefense = P_UPDATED_STATS >= GEN_2 ? 85 : 35,
        .types = MON_TYPES(TYPE_FIGHTING),
        .catchRate = 45,
    ...
    [SPECIES_LICKITUNG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_RIPEN, ABILITY_GLUTTONY, ABILITY_CLOUD_NINE },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_RHYHORN] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 40, SPECIES_RHYDON}),
    },
    ...
    [SPECIES_RHYDON] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_SAP_SIPPER, ABILITY_ROCK_HEAD, ABILITY_RECKLESS },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_RHYPERIOR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_MEGA_LAUNCHER, ABILITY_SOLID_ROCK, ABILITY_RECKLESS },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_GOLDEEN] =
    {
        ...
        .abilities = { ABILITY_QUEENLY_MAJESTY, ABILITY_WATER_VEIL, ABILITY_LIGHTNING_ROD },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_MIME_JR] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_PSYCHIC_SURGE, ABILITY_FILTER, ABILITY_TECHNICIAN },
    #else
    ...
    [SPECIES_SCYTHER] =
    {
        ...
        .baseSpeed     = 105,
        .baseSpAttack  = 55,
        .baseSpDefense = P_UPDATED_STATS >= GEN_2 ? 90 : 55,
        .types = MON_TYPES(TYPE_BUG, TYPE_FLYING),
        .catchRate = 45,
    ...
    [SPECIES_SMOOCHUM] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 26, SPECIES_JYNX}),
    },
#endif //P_GEN_2_CROSS_EVOS
    ...
    [SPECIES_JYNX] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_FOREWARN, ABILITY_NEUROFORCE },
    #else
    ...
    [SPECIES_ELECTABUZZ] =
    {
        ...
        .baseDefense   = 57,
        .baseSpeed     = 105,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 85 : 85,
        .baseSpDefense = 85,
        .types = MON_TYPES(TYPE_ELECTRIC, TYPE_FIGHTING),
        .catchRate = 45,
    ...
    [SPECIES_TAUROS] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_CUD_CHEW, ABILITY_GORILLA_TACTICS, ABILITY_SHEER_FORCE },
    #else
    ...
    [SPECIES_LAPRAS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_SNOW_WARNING, ABILITY_SHELL_ARMOR, ABILITY_RUN_AWAY },
        .bodyColor = BODY_COLOR_BLUE,
...
#define EEVEE_SP_ATK (P_UPDATED_STATS >= GEN_2 ? 45 : 65)
...
#if P_UPDATED_ABILITIES >= GEN_4
    #define EEVEE_ABILITIES { ABILITY_FLUFFY, ABILITY_ADAPTABILITY, ABILITY_ANTICIPATION }
#else
    ...
    [SPECIES_VAPOREON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_WATER_ABSORB, ABILITY_HYDRATION, ABILITY_ANALYTIC },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_JOLTEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_VOLT_ABSORB, ABILITY_QUICK_FEET, ABILITY_SPEED_BOOST },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_ESPEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SYNCHRONIZE, ABILITY_TINTED_LENS, ABILITY_MAGIC_BOUNCE },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SYLVEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_PRANKSTER, ABILITY_PIXILATE },
        .bodyColor = BODY_COLOR_PINK,
        .noFlip = TRUE,
    ...
    [SPECIES_OMASTAR] =
    {
        ...
        .baseSpeed     = 55,
        .baseSpAttack  = 115,
        .baseSpDefense = P_UPDATED_STATS >= GEN_2 ? 80 : 115,
        .types = MON_TYPES(TYPE_ROCK, TYPE_WATER),
        .catchRate = 45,
    ...
    [SPECIES_SNORLAX] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_FUR_COAT, ABILITY_THICK_FAT, ABILITY_GLUTTONY },
        .bodyColor = BODY_COLOR_BLACK,
