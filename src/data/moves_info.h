...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_PARABOLIC_CHARGE] =
    {
        ...
        .effect = EFFECT_ABSORB,
        .power = B_UPDATED_MOVE_DATA >= GEN_7 ? 70 : 50,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
        .pp = 20,
        .target = TARGET_BOTH,
    ...
    [MOVE_ZIPPY_ZAP] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_8 ? 40 : 50,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
    ...
    [MOVE_BOUNCY_BUBBLE] =
    {
        ...
        #endif
        .effect = EFFECT_ABSORB,
        .power = B_UPDATED_MOVE_DATA >= GEN_8 ? 70 : 90,
        .type = TYPE_WATER,
        .accuracy = 100,
    ...
    [MOVE_GLITZY_GLOW] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_8 ? 50 : 90,
        .type = TYPE_PSYCHIC,
    ...
    [MOVE_SAPPY_SEED] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_8 ? 65 : 90,
        .type = TYPE_GRASS,
    ...
    [MOVE_DRACO_MAW] =
    {
        .name = COMPOUND_STRING("Jaws of Life"),
        .description = COMPOUND_STRING(
            "An attack that steals half\n"
            "the damage inflicted."),
        .effect = EFFECT_ABSORB,
