...
// GEN 9 ITEMS
    ...
    [ITEM_POKESHI_DOLL] =
    {
     ...
     [ITEM_CUT_TOOL] =
    {
        .name = ITEM_NAME("Tree Begone Spray"),
        .price = 0,
        .description = COMPOUND_STRING(
            "A herbicide that\n"
            "gets rid of trees\n"
    ...
    [ITEM_STRENGTH_TOOL] =
    {
        .name = ITEM_NAME("Rock Moving Gear"),
        .price = 0,
        .description = COMPOUND_STRING(
            "Grants the power\n"
            "to move heavy\n"
    ...
    {
        .name = ITEM_NAME("Rock Smashing Gear"),
        .price = 0,
        .description = COMPOUND_STRING(
            "Sturdy gear for\n"
            "smashing cracked\n"
    ...
    [ITEM_WATERFALL_TOOL] =
    {
        .name = ITEM_NAME("Waterfalling Gear"),
        .price = 0,
        .description = COMPOUND_STRING(
            "Enables climbing\n"
            "up steep, roaring\n"
